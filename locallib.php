...
class att_page_with_filter_controls {
    ...
    protected $defaultcollapsetype      = 2;
    ...
    private function init_collapsetype() {
        global $SESSION;

        if (isset($this->collapsetype)) {
            $SESSION->attcollapsetype = $this->collapsetype;
        }
        elseif (isset($SESSION->attcollapsetype)) {
            $this->collapsetype = $SESSION->attcollapsetype;
        }
        else {
            $this->collapsetype = $this->defaultcollapsetype;
        }
    }
...
class att_take_page_params {
    ...
    public function init() {
        ...
        if (!isset($this->sort)) $this->sort = ATT_SORT_FIRSTNAME;
        $this->init_view_mode();
        $this->init_gridcols();
    }
    ...
    public function get_significant_params() {
        ...
        if ($this->sort != ATT_SORT_FIRSTNAME) $params['sort'] = $this->sort;
